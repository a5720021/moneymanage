...
class NewVisitorTest(StaticLiveServerTestCase):
    ...
    def setUp(self):
        ...
        #self.browser = webdriver.Chrome('C:/Users/MUNGGY/Documents/Project/money/functional_tests/chromedriver.exe')
    ...
    def test_can_start_a_list_and_retrieve_it_later(self):
        ...
        #He's now logging in.But! he login with wrong password
        ...
        password_login.send_keys('987911')
        self.browser.find_element_by_id("id_sub").click()
        time.sleep(2)
        self.browser.find_element_by_link_text('Return to home').click()
        time.sleep(2)

        #He retry to log-in to moneymanagement homepage.
        login_name = self.browser.find_element_by_id('id_usr')
        login_name.send_keys('test')
        password_login = self.browser.find_element_by_id('id_pw')
        ...
        #He fill his saving data but he found error because he fill amount with
        #string value
        sav_type = self.browser.find_element_by_id("id_type")
        sav_type.click()
        inputbox1 = self.browser.find_element_by_id('id_val')
        inputbox1.send_keys('Money in banking')
        inputbox2 = self.browser.find_element_by_id('id_des')
        inputbox2.send_keys('17000')
        self.browser.find_element_by_id("id_sub").click()
        time.sleep(2)

        #he found error page, he back to Saving and retry to fill his data
        self.browser.find_element_by_partial_link_text(
            'Return to Saving Management').click()
        time.sleep(2)
